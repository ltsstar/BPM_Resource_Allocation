...
def try_mine_problem():
    log = pandas.read_csv("bpo-project/bpo/resources/BPI Challenge 2017 - clean.zip")
    ...
    problem.save("bpo-project/temp/BPI Challenge 2017 - clean Jan Jun - problem.pickle")


# Load a mined problem from file, simulating it and saving the log
def try_simulate_mined_problem():
    problem = MinedProblem.from_file("bpo-project/temp/BPI Challenge 2017 - clean Jan Jun - problem.pickle")
